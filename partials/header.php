                ...
                if(isset($_SESSION['user_id'])){
                  ...
                  <div class="dropdown user-menu">
                        <a class="btn dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                          <img src="images/dummy.jpeg" width="30" style="border-radius: 50%;"> Hi <?php echo isset($data['firstname']) ? $data['firstname'] : "";?>
                        </a>
                      
                        <ul class="dropdown-menu user-profile" style="border-radius: 0px;">
                          <li><a class="dropdown-item" href="finance_dashboard.php">Profile</a></li>
